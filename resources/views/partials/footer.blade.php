        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6">
            <div class="footer-info">
              <h3><img src="/dashboardAssets/img/Logo_Jeneponto.png" alt="" width="150px" height="150px"></h3>
              <p>
                Empoang Kec. Binamu, Kabupaten Jeneponto, Sulawesi Selatan.
              </p>
          ...
          <div class="col-lg-4 col-md-6 footer-newsletter">
            ...
            <p>Kirimkan email anda untuk mendapatkan update informasi tentang layanan Disdukcapil Kabupaten Jeneponto</p>
