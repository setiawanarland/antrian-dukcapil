                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="btn-group" role="group">
                                                ...
                                                <form id="{{ $detail->id }}" action="/antrian/detail/{{ $detail->id }}"
                                                    method="POST" class="d-inline">
                                                    @method('delete')
                                                    @csrf
                                                    <button type="submit"
                                                        class="btn btn-danger btn-icon-split mb-2 swal-confirm"
                                                        data-form="{{ $detail->id }}">
                                                ...
                                                {{-- <button type="button"
                                                    class="btn btn-success btn-icon-split mb-2 btn-print penjualanPrint"
                                                    data-id="{{ $detail->id }}">
                                                    <span class="icon text-white-100">
                                                ...
                                                <a class="btn btn-success btn-icon-split mb-2"
                                                    href="/antrian/kode-antrian/{{ $detail->id }}" target="_blank"
                                                    role="button">
                                                    <span class="icon text-white-100">
                                                        <i class="bi bi-printer"></i>
                                                    </span>
    ...
    <script>
        $(document).on('click', '.penjualanPrint', function(e) {
                ...
                popupWin.document.write(
                    '<html><body onload="document.title=`Sistem Antrian Dukcapil Online`;">' +
                    html + '</html>');
