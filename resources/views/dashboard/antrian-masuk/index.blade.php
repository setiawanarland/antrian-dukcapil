            ...
            <div class="col-xl">
                <div class="card shadow mb-2">
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                        <h6 class="m-0 font-weight-bold text-primary">Antrian Masuk Layanan {{ $antrian->nama_antrian }}</h6>
                        <form id="{{ $antrian->slug }}" action="/dashboard/antrian-masuk/{{ $antrian->slug }}/reset"
                            method="POST">
                            @csrf
                            @method('delete')
                            <button type="submit" class="btn btn-primary reset-confirm" data-form="{{ $antrian->slug }}"><i
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped">
                                ...
                                <tbody style="text-align: center">
                                    ...
                                    @if ($antrian->ambilantrians)
                                        @foreach ($antrian->ambilantrians as $antrian_masuk)
                                            <tr>
                                                <td style="font-size: 20px; font-weight: bold;">{{ $antrian_masuk->kode }}
                                                </td>
                                                ...
                                                <td>
                                                    ...
                                                    <body onunload="responsiveVoice.cancel();">
                                                        <button class="btn btn-primary"
                                                            onclick="responsiveVoice.speak('Nomor Antrian {{ $antrian_masuk->kode }} Menuju ke loket {{ $antrian_masuk->antrian->nama_antrian }}', 'Indonesian Female', {rate: 0.9});"
                                                            onblur="responsiveVoice.cancel();" type="button"
                                                ...
                                                <td>
                                                    ...
                                                    <form id="{{ $antrian_masuk->id }}"
                                                        ...
                                                        <button type="submit" class="btn btn-success"><i
                                                                class="bi bi-check2-all"></i> Ada</button>
                                                    </form>
                                                    ...
                                                    <form id="{{ $antrian_masuk->id }}"
                                                        ...
                                                        <button type="submit" class="btn btn-danger"><i
                                                                class="bi bi-skip-forward"></i> Lewati</button>
                                                    </form>
                                                </td>
                                            </tr>
                                        @endforeach
