                          ...
                          <tr>
                            ...
                            <td>
                              ...
                              <body onunload="responsiveVoice.cancel();">
                                <button class="btn btn-primary" onclick="responsiveVoice.speak('Nomor Antrian {{ $antrian_masuk->kode }} Menuju ke loket {{ $antrian_masuk->antrian->nama_layanan }}', 'Indonesian Female', {rate: 0.9});" onblur="responsiveVoice.cancel();" type="button" value="Play"><i class="bi bi-mic"></i></button>
                              </body>
                            </td>
                            <td>
