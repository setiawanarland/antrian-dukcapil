                        ...
                        <form action="{{ route('register') }}" class="user" method="POST">
                            ...
                            <div class="form-group">
                                <input type="number" onKeyPress="if(this.value.length==16) return false;"
                                    ...
                                    name="nik" placeholder="Masukkan 16 Digit NIK Anda ...">
                                @error('nik')
                            ...
                            <div class="form-group">
                                <input type="tempat_lahir"
                                    ...
                                    id="tempat_lahir" name="tempat_lahir" placeholder="Masukkan Tempat Lahir Anda ...">
                                @error('tempat_lahir')
                                    <span class="invalid-feedback" role="alert">
                                        <p>{{ $message }}</p>
                                    </span>
                            ...
                            <div class="form-group">
                                <input type="password"
                                    class="form-control form-control-user @error('password') is-invalid @enderror"
                                    id="password" name="password_confirmation" placeholder="Masukkan Password">
